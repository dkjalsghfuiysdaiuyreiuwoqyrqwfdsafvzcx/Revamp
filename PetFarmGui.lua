...
screenGui.Name = "MidRightTextBox"
...
frame.AnchorPoint = Vector2.new(0.5, 0.5) -- anchor to middle right
frame.Position = UDim2.new(0.5, 0, 0.5, -200) -- near right edge, centered vertically
    ...
    local Window = Rayfield:CreateWindow({
     ...
     local StartButton2 = FarmTab:CreateButton({
        ...
        Callback = function()
            ...
            textLabel.Text = "Double Pet Farm."
            Rayfield:Notify({
                Title = "Status",
